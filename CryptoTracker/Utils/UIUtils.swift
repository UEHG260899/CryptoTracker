...
final class UIUtils {
    ...
    let titleTextAttributes: [NSAttributedString.Key : Any] = [.font : UIFont(name: "RobotoMono-Medium", size: 17), .foregroundColor : UIColor(named: "TextColor")]
...
extension UIUtils {
    ...
    public func setupNagivation() -> UINavigationController {
        ...
        navController.navigationBar.tintColor = UIColor(named: "TextColor")!
